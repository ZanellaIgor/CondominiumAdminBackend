...
-- CreateEnum
CREATE TYPE "SituationReservation" AS ENUM ('ABERTO', 'ANALISE', 'CONFIRMADO', 'REPROVADO', 'FINALIZADO', 'CANCELADO');
...
CREATE TABLE "Reservation" (
    ...
    "situation" "SituationReservation" NOT NULL DEFAULT 'ABERTO',
    "condominiumId" INTEGER NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "Reservation_spaceReservationId_startDateTime_endDateTime_key" ON "Reservation"("spaceReservationId", "startDateTime", "endDateTime");
